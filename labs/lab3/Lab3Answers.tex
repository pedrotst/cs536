...
To create such a file create a file with one character per line,
...
To create such a file we use the following bash script
...
At \ref{fig:wireshark} we can see a picture of wireshark, great a tool
