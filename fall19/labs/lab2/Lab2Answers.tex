...
\item The experiment B was perfomed running the receiver on pod1-1 and the sender on escher01.
  ...
  In order to set the timeout we need first to figure out what is the RTT between pod1-1 and escer01.
  For this we run \verb|ping pod1-1.cs.purdue.edu| in escher01. Which outputs the following:
...
This output suggests that the the RTT between escher01 and pod1-1 is 1.117 and K = 2 * 1.041 = 2.082.
...
Therefore the RTT between pod2-1 and pod101 is 0.208
and so K = 2*0.208 = 0.416.
